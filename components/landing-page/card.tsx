        ...
        <div className="flex items-center gap-3 flex-1">
          {image ? (
            <img
              src={image}
              alt={title}
              className="w-12 h-12 rounded-md object-cover bg-[#444654]"
            />
          ) : (
            <div className="w-12 h-12 rounded-md bg-[#444654]" />
          )}
      ...
      <div className="space-y-4">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="flex-1 px-3 py-2 bg-[#393C44] hover:bg-[#4A4E57] rounded-md text-sm text-gray-400 hover:text-white transition"
          >
            +$20
          </button>
